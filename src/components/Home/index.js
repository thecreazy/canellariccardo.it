...
export default class Home extends Component{
    ...
    render(){
        return <section id="home">
            ...
            <p className="__fulltwo-tre">From Italy living in Parma, where I work as a Frontend Developer at <a href="https://caffeina.com" target="_blank" rel="noopener">Caffeina</a>. With a fullstack javascript background, my strength lies in websites and apps. If you want to know more about me, my work or if youʼre a head hunter who wants to offer me a lot of money, feel free to contact me on canella_riccardo[at]icloud.com.</p>
